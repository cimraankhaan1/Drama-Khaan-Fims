...
# add admin IDs
ADMINS = list(map(int, environ.get('ADMINS', '5788827080').split()))  # List of admin user IDs
AUTH_CHANNEL = list(map(int, environ.get("AUTH_CHANNEL", "-1002102037760 -1002012150170").split()))  # Allowed channels
...
CHANNEL = environ.get('CHANNEL', 'https://t.me/+OkZLiISfyNs4YmI0')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://media.khaanfilms.com')  # Support group
